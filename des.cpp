...
const int DES::iteration_times = 16;

const unsigned short DES::IP[] = {57, 49, 41, 33, 25, 17, 9, 1, 59, 51, 43, 35, 27, 19, 11, 3,  \
							61, 53, 45, 37, 29, 21, 13, 5, 63, 55, 47, 39, 31, 23, 15, 7, \
							56, 48, 40, 32, 24, 16, 8, 0, 58, 50, 42, 34, 26, 18, 10, 2,  \
							60, 52, 44, 36, 28, 20, 12, 4, 62, 54, 46, 38, 30, 22, 14, 6, \
};

const unsigned short DES::IPinv[] = {39, 7, 47, 15, 55, 23, 63, 31, 38, 6, 46, 14, 54, 22, 62, 30, \
...
const unsigned short DES::E[] = {31, 0, 1, 2, 3, 4, 3, 4, 5, 6, 7, 8, 7, 8, 9, 10, \
								11, 12, 11, 12, 13, 14, 15, 16, 15, 16, 17, 18, 19, 20, 19, 20, \
								21, 22, 23, 24, 23, 24, 25, 26, 27, 28, 27, 28, 29, 30, 31, 0, \
};

const unsigned short DES::SP[] = { 15, 6, 19, 20, 28, 11, 27, 16, 0, 14, 22, 25, 4, 17, 30, 9, \
								1, 7, 23, 13, 31, 26, 2, 8, 18, 12, 29, 5, 21, 10, 3, 24 \
};

const unsigned short DES::S[8][4][16] = {
...
const unsigned short DES::LeftShiftsNumber[] = {1, 1, 2, 2, 2, 2, 2, 2, 1, 2, 2, 2, 2, 2, 2, 1};

const unsigned short DES::PC1[] = {56, 48, 40, 32, 24, 16, 8, 0, 57, 49, 41, 33, 25, 17, 9, 1, \
								58, 50, 42, 34, 26, 18, 10, 2, 59, 51, 43, 35, 62, 54, 46, 38, \
								30, 22, 14, 6, 61, 53, 45, 37, 29, 21, 13, 5, 60, 52, 44, 36,  \
								28, 20, 12, 4, 27, 19, 11, 3, \
};

const unsigned short DES::PC2[] = {13, 16, 10, 23, 0, 4, 2, 27, 14, 5, 20, 9, 22, 18, 11, 3, \
...
DES::Key::Key(const unsigned long long &K) 
{
	key = K;
	// 求C[0],D[0]
...
unsigned long long DES::F_funtion(const unsigned long long &R, const unsigned long long &K) 
{
...
unsigned long long DES::permutation(const unsigned short *arr, int ansLen, const unsigned long long &num, int numLen)
{
	unsigned long long ans = 0;
...
unsigned long long DES::encode(const unsigned long long &M, const unsigned long long &K) { return coder(M, K, 1); }
unsigned long long DES::decode(const unsigned long long &S, const unsigned long long &K) { return coder(S, K, 0); }
